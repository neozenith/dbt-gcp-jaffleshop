...
| --- | --- | --- | --- | --- |
| MS-02 | measure | Consistency | Representational consistency + Interpretability | free (declaration) + runtime (cross-grain reconciliation) |
...
flowchart TD
    ...
    classDef semiok fill:#c2410c30,stroke:#f97316,stroke-width:1px
...
- [`MS-01-numeric-range.md`](./MS-01-numeric-range.md) — bound the values themselves
- [`../model/MD-04-refactor-parity.md`](../model/MD-04-refactor-parity.md) — for the cross-grain reconciliation pattern
