...
| --- | --- | --- | --- | --- |
| MS-04 | measure | Validity | Believability | cheap |
...
flowchart LR
    ...
    classDef nan fill:#dc262636,stroke:#ef4444,stroke-width:2px
```
...
- [`MS-01-numeric-range.md`](./MS-01-numeric-range.md) — the value-bounded complement
- [`MS-05-distribution-anomaly.md`](./MS-05-distribution-anomaly.md) — for detecting "the metric silently changed" after a NaN incident
