...
| --- | --- | --- | --- | --- |
| EN-04 | entity | Consistency | Representational consistency | scan-bound |
...
A soft-deleted product whose historical orders should keep their name needs SCD2 history, not a soft-delete column. The right fix to F.11 in the wild is often "make `dim_product` SCD2" — see [`../time/TM-AU-02-scd2-quartet.md`](../time/TM-AU-02-scd2-quartet.md).
...
| Make the parent SCD2 instead | model design | When historical referential correctness matters more than current-state speed. See [`../time/TM-AU-02-scd2-quartet.md`](../time/TM-AU-02-scd2-quartet.md). |
...
- [`EN-03-foreign-key-integrity.md`](./EN-03-foreign-key-integrity.md) — the unscoped version
- [`../time/TM-AU-02-scd2-quartet.md`](../time/TM-AU-02-scd2-quartet.md) — the structural fix for "historical orders need historical product names"
