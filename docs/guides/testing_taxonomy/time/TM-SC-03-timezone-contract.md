...
| --- | --- | --- | --- | --- |
| TM-SC-03 | time (event-time scalar) | Validity | Believability + Interpretability | free (compile-time) |
...
- [`TM-SC-01-event-time-bounds.md`](./TM-SC-01-event-time-bounds.md) — bounds depend on `NOW()` which is TZ-sensitive
- [`../entity/EN-06-type-stable-join.md`](../entity/EN-06-type-stable-join.md) — TIMESTAMP-vs-DATETIME join failures
- [`../model/MD-02-contracts.md`](../model/MD-02-contracts.md) — full contract reference
