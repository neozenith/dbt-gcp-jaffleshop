...
| --- | --- | --- | --- | --- |
| TM-GR-01 | time (time-grain dimension) | Completeness + Timeliness | Completeness + Timeliness | cheap |
...
- [`TM-SC-01-event-time-bounds.md`](./TM-SC-01-event-time-bounds.md) — bounding the values within the spine
- [`TM-AU-01-freshness-source-and-model.md`](./TM-AU-01-freshness-source-and-model.md) — when the spine should but doesn't auto-extend
- [`../entity/EN-02-compound-grain.md`](../entity/EN-02-compound-grain.md) — `(user_id, date_day)` uniqueness on a daily fact
