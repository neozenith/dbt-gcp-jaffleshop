...
| --- | --- | --- | --- | --- |
| TM-AU-02 | time (system-time / audit) | Consistency | Representational consistency | scan-bound |
...
- **The model is SCD Type 1** (overwrite-in-place, no history). Use the plain entity tests ([`../entity/EN-01-unique-key.md`](../entity/EN-01-unique-key.md)) instead.
...
- [`TM-SC-02-monotonic-pair.md`](./TM-SC-02-monotonic-pair.md) — for `valid_to >= valid_from` (the "non-empty windows" piece in isolation)
- [`../entity/EN-04-soft-delete-scoped-fk.md`](../entity/EN-04-soft-delete-scoped-fk.md) — when consumers must scope to `is_current = true`
