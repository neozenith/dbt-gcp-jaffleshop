...
| --- | --- | --- | --- | --- |
| TM-SC-02 | time (event-time scalar pair) | Consistency | Representational consistency | cheap |
...
- [`TM-SC-01-event-time-bounds.md`](./TM-SC-01-event-time-bounds.md) — the single-column bounds half
- [`TM-AU-02-scd2-quartet.md`](./TM-AU-02-scd2-quartet.md) — for `valid_from <= valid_to` (the SCD2 specialisation)
