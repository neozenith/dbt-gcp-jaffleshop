...
| --- | --- | --- | --- | --- |
| DM-02 | dimension | Validity + Accuracy | Believability + Accuracy | cheap |
...
This learns the natural growth rate and fires only on Z-score outliers. See [`DM-05-dimension-anomalies.md`](./DM-05-dimension-anomalies.md).
...
- [`DM-01-accepted-values.md`](./DM-01-accepted-values.md) — when the value set is known
- [`DM-05-dimension-anomalies.md`](./DM-05-dimension-anomalies.md) — for distribution-aware variants
- [`../measure/MS-05-distribution-anomaly.md`](../measure/MS-05-distribution-anomaly.md) — the measure-side equivalent
