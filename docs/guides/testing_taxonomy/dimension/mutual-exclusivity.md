...
- [`accepted-values.md`](./accepted-values.md) — the single-enum alternative
- [`../measure/numeric-range.md`](../measure/numeric-range.md) — for the numeric-sum-equals-1 variant
