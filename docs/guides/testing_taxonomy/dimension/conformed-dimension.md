...
- [`accepted-values.md`](./accepted-values.md) — single-model variant
- [`../entity/foreign-key-integrity.md`](../entity/foreign-key-integrity.md) — the test mechanism (relationships) used here
