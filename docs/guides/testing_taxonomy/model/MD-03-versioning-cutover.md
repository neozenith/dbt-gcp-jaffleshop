...
| --- | --- | --- | --- | --- |
| MD-03 | model-level | Consistency | Representational consistency | free (declaration) |
...
Prove that v2 can reconstruct v1's semantics. See [`MD-04-refactor-parity.md`](./MD-04-refactor-parity.md) for the audit_helper-based pattern.
...
- [`MD-02-contracts.md`](./MD-02-contracts.md) — the foundation versioning builds on
- [`MD-04-refactor-parity.md`](./MD-04-refactor-parity.md) — the equivalence test pattern
