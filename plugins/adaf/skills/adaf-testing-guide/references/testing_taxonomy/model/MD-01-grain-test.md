...
| --- | --- | --- | --- | --- |
| MD-01 | model-level | Uniqueness | Concise representation | scan-bound |
...
If you adopt model contracts, the grain test pairs with a `primary_key` constraint on the same columns. On BigQuery the constraint is informational (not enforced); the test is what actually validates. See [`MD-02-contracts.md`](./MD-02-contracts.md).
...
- [`../entity/EN-02-compound-grain.md`](../entity/EN-02-compound-grain.md) — entity-side framing of the same test
- [`../entity/EN-01-unique-key.md`](../entity/EN-01-unique-key.md) — single-column variant
- [`MD-02-contracts.md`](./MD-02-contracts.md) — the constraint side of the same idea
