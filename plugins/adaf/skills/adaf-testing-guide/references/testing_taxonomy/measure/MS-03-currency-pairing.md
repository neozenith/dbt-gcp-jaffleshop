...
| --- | --- | --- | --- | --- |
| MS-03 | measure | Validity + Accuracy | Believability + Accuracy | free (contract) + cheap (test) |
...
See [`MS-05-distribution-anomaly.md`](./MS-05-distribution-anomaly.md) for the learned-band variant.
...
flowchart LR
    ...
    classDef measurePrimary fill:#0478572e,stroke:#10b981,stroke-width:2px
...
- [`MS-01-numeric-range.md`](./MS-01-numeric-range.md) — the range half
- [`MS-05-distribution-anomaly.md`](./MS-05-distribution-anomaly.md) — scale-drift detection
