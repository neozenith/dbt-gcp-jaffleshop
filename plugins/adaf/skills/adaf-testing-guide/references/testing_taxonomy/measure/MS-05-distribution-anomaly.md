...
| --- | --- | --- | --- | --- |
| MS-05 | measure | Accuracy | Accuracy | history-bound |
...
- [`MS-01-numeric-range.md`](./MS-01-numeric-range.md) — the static-band complement
- [`../dimension/DM-05-dimension-anomalies.md`](../dimension/DM-05-dimension-anomalies.md) — the per-dimension variant
- [`../model/MD-07-volume-anomaly.md`](../model/MD-07-volume-anomaly.md) — model-level (count) version
